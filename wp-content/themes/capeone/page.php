<?php
	get_header();
	$page_sidebar_layout = apply_filters('vela_page_sidebar_layout',capeone_option('page_sidebar_layout'));
...
?>
<?php echo apply_filters('capeone_page_title_bar','','page');?>  
<div class="page-wrap">
<?php do_action('vela_before_page_wrap');?>
  <div class="container">
    <div class="page-inner row <?php echo $aside_class; ?>">
      ...
      <?php capeone_get_sidebar($page_sidebar_layout,'page');?>
    </div>
  </div>
