	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'capeone' ),
				'remove'               => esc_attr__( 'Remove', 'capeone' ),
				'default'              => esc_attr__( 'Default', 'capeone' ),
				'selectFile'           => esc_attr__( 'Select File', 'capeone' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'capeone' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'capeone' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'capeone' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'capeone' ),
			)
		);
