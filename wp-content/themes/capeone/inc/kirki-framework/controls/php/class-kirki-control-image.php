...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'capeone' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'capeone' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'capeone' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'capeone' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'capeone' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'capeone' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'capeone' ); ?>',
		} );
		#>
		<label>
