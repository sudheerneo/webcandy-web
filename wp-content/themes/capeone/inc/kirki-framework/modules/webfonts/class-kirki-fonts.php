...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'capeone' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'capeone' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'capeone' ),
			'200'       => esc_attr__( 'Light 200', 'capeone' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'capeone' ),
			'300'       => esc_attr__( 'Book 300', 'capeone' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'capeone' ),
			'400'       => esc_attr__( 'Normal 400', 'capeone' ),
			'regular'   => esc_attr__( 'Normal 400', 'capeone' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'capeone' ),
			'500'       => esc_attr__( 'Medium 500', 'capeone' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'capeone' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'capeone' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'capeone' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'capeone' ),
			'700'       => esc_attr__( 'Bold 700', 'capeone' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'capeone' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'capeone' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'capeone' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'capeone' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'capeone' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'capeone' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'capeone' ),
		);
	}
