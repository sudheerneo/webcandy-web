...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'capeone' ),
				'change'       => esc_attr__( 'Change image', 'capeone' ),
				'default'      => esc_attr__( 'Default', 'capeone' ),
				'remove'       => esc_attr__( 'Remove', 'capeone' ),
				'placeholder'  => esc_attr__( 'No image selected', 'capeone' ),
				'frame_title'  => esc_attr__( 'Select image', 'capeone' ),
				'frame_button' => esc_attr__( 'Choose image', 'capeone' ),
			)
		);
	}
