<?php
	...
	$page_sidebar_layout = apply_filters('vela_page_sidebar_layout', capeone_option('blog_sidebar_layout'));
...
?>
<?php echo apply_filters('capeone_page_title_bar','','post');?> 
<div class="page-wrap">
<?php do_action('vela_before_page_wrap');?>
  <div class="container">
    <div class="page-inner row <?php echo $aside_class; ?>">
      <div class="col-main">
        <section class="post-main" role="main" id="content">
          <article class="post-entry text-left">
            <?php do_action('vela_before_post_content');?>
            <?php
				/* Start the Loop */
			...
			?>
            <?php do_action('vela_after_post_content');?>
            
            <div class="entry-footer clearfix">
              <div class="pull-left"> 
              <?php
				  if(get_the_tag_list()) {
					  echo get_the_tag_list(__( 'Tags: ', 'capeone' ),', ');
				  }
      ...
      <?php capeone_get_sidebar($page_sidebar_layout,'blog');?>
    </div>
  </div>
