...
<?php
	...
	$class = 'capeone-header capeone-split-header ';
	$sticky_class = 'capeone-header capeone-split-header shadow';
	$split_header_menu_position = esc_attr( capeone_option('split_header_menu_position'));
