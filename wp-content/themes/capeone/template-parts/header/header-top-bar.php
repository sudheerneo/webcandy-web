<?php 
$display_topbar = capeone_option('display_topbar');
if($display_topbar==1 || is_customize_preview() ):
$css_class = 'capeone-top-bar';
if( $display_topbar !=1 && is_customize_preview() )
	$css_class  .= ' hide';
?>
      ...
      <?php endif;?>
			...
			if(is_array($topbar_left) && !empty($topbar_left)):
                ...
                <div class="capeone-microwidget capeone-microicons topbar_icons_selective">
                 <?php if( is_customize_preview() ):?>
      <span class="customize-partial-edit-shortcut customize-partial-edit-shortcut-topbar_icons_selective"><button aria-label="<?php echo esc_html__( 'Click to edit this element.', 'capeone' );?>" title="<?php echo esc_html__( 'Click to edit this element.', 'capeone' );?>" class="customize-partial-edit-shortcut-button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13.89 3.39l2.71 2.72c.46.46.42 1.24.03 1.64l-8.01 8.02-5.56 1.16 1.16-5.58s7.6-7.63 7.99-8.03c.39-.39 1.22-.39 1.68.07zm-2.73 2.79l-5.59 5.61 1.11 1.11 5.54-5.65zm-2.97 8.23l5.58-5.6-1.07-1.08-5.59 5.6z"></path></svg></button></span>
      <?php endif;?>
                <?php
			$topbar_icons = capeone_option('topbar_icons');
			...
			if(is_array($topbar_icons) && !empty($topbar_icons)):
                ...
                <div class="capeone-microwidget capeone-micronav capeone-micronav-list topbar_right_selective">
                 <?php if( is_customize_preview() ):?>
      <span class="customize-partial-edit-shortcut customize-partial-edit-shortcut-topbar_right_selective"><button aria-label="<?php echo esc_html__( 'Click to edit this element.', 'capeone' );?>" title="<?php echo esc_html__( 'Click to edit this element.', 'capeone' );?>" class="customize-partial-edit-shortcut-button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M13.89 3.39l2.71 2.72c.46.46.42 1.24.03 1.64l-8.01 8.02-5.56 1.16 1.16-5.58s7.6-7.63 7.99-8.03c.39-.39 1.22-.39 1.68.07zm-2.73 2.79l-5.59 5.61 1.11 1.11 5.54-5.65zm-2.97 8.23l5.58-5.6-1.07-1.08-5.59 5.6z"></path></svg></button></span>
      <?php endif;?>
            <?php
			$topbar_right = capeone_option('topbar_right');
