...
BeOnePage WordPress Theme, Copyright 2017 http://betheme.me/
BeOnePage is distributed under the terms of the GNU GPL
...
BeOnePage bundles the following third-party resources:

Montserrat Font by Julieta Ulanovsky, https://fonts.google.com/specimen/Dosis
Licensed under the Open Font License, http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL_web

The following resources are included within the theme package.

* Bootstrap, Copyright (c) 2011-2016 Twitter, Inc.
  License: MIT Source: http://getbootstrap.com/
...
Copyright (c) 2017 BeTheme, http://betheme.me/
